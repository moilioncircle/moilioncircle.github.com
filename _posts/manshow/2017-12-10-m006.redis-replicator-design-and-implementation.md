...
category: manshow
author: chen.baoyi
title: "M006.Redis-replicator 设计与实现"
excerpt: "Redis-replicator 设计与实现，及redis replication协议讲解。"
tags: [redis, replication, java, 代码]
teaser: post/manshow/006.jpg
teaserinfo: Customized keyboard made by Leon.
modified: 
...
# M006.Redis-replicator 设计与实现

Redis-replicator 设计与实现，及redis replication协议讲解。  

@陈宝仪 / 2017-12-10 / CC-BY-SA-3.0  
...
如下图所示：  
![图1](/images/post/manshow/006/img1.png)
...
如下图所示：  
![图2](/images/post/manshow/006/img2.png)
...
源码结构如下图所示  
![图7](/images/post/manshow/006/img7.png)  
...
如下图所示:  
![图4](/images/post/manshow/006/img4.png)  
...
![图6](/images/post/manshow/006/img6.png)  
