...
## 参考资源
  ...
  * [Mysql-5.1 性能优化](http://dev.mysql.com/doc/refman/5.5/en/statement-optimization.html)

  * [Mysql-5.1 DML:增(insert)](http://dev.mysql.com/doc/refman/5.5/en/insert.html)
  * [Mysql-5.1 DML:删(delete)](http://dev.mysql.com/doc/refman/5.5/en/delete.html)
  * [Mysql-5.1 DML:改(update)](http://dev.mysql.com/doc/refman/5.5/en/update.html)
  * [Mysql-5.1 DML:查(select)](http://dev.mysql.com/doc/refman/5.5/en/select.html)

  * [Mysql-5.1 子查询(subqueries)](http://dev.mysql.com/doc/refman/5.5/en/subqueries.html)
  * [Mysql-5.1 插入或替换(replace)](http://dev.mysql.com/doc/refman/5.5/en/replace.html) 
  * [Mysql-5.1 重复时更新(duplicate)](http://dev.mysql.com/doc/refman/5.5/en/insert-on-duplicate.html)
  * [Mysql-5.1 聚集：列变行](http://dev.mysql.com/doc/refman/5.5/en/group-by-functions.html) 
  * [Mysql-5.1 聚集：合计](http://dev.mysql.com/doc/refman/5.5/en/group-by-modifiers.html) 
